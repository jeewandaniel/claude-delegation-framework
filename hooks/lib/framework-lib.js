...
const DEFAULTS = {
  // Context-hygiene module (modules/context-hygiene); unread by the default delegation-only install.
...
module.exports = {
  ...
  auxPath, readAux, writeAux, STATE_DEFAULTS, readState, writeState,
